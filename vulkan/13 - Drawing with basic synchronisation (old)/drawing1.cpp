...
/*------------------- variables ----------------------*/
	...
	void drawFrame() {
		...
		VkSemaphore waitSemaphores[] = { imageAvailableSemaphore }; //due to multithreading, this line might be reached before
		...
		VkSemaphore signalSemaphores[] = { renderFinishedSemaphore }; //the signal semaphore will be taken and then released once the commandbuffer is done
