    ...
    def __init__(self, width: int, height: int, 
        ...
        self.states = (
            GameRenderer(width, height, game_map, colors, textures, 
                         ...
                         self.event_queue, self.observers, player_state),
...
class GameRenderer:
    ...
    def update(self, frametime: float):
        ...
        tint_color = self.screen.map_rgb((tint_r, tint_g, tint_b))
        self.screen_pixels |= tint_color
        pg.surfarray.blit_array(self.screen, self.screen_pixels)
        self.draw_gun(frametime)
        pg.draw.rect(self.screen, (0, 16, 128), (0, 450, 800, 600))
        self.draw_text(f"Health: {self.player_state[0]}", (50, 450))
        self.draw_text(f"Ammo: {self.player_state[1]}", (450, 450))
