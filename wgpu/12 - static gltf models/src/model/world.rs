...
use crate::model::transform_component::TransformComponent;

pub struct World {
    pub quads: Vec<Object>,
    pub tris: Vec<Object>,
    pub characters: Vec<TransformComponent>,
    pub camera: Camera,
...
impl World {
    ...
    pub fn new() -> Self {
        ...
        let test_character = TransformComponent {
            position: vec3(0.0, -1.0, -2.0),
            eulers: vec3(90.0, 0.0, 0.0),
            scale: 2.0};
