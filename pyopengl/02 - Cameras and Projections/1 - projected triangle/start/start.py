...
class App:
    ...
    def set_onetime_unforms(self) -> None:
        ...
        """
        """
            TODO: tell pyrr to create a matrix44 perspective projection.
                set the field of view y angle to 45 degrees
                set the aspect ratio to screen width / screen height
                for near and far distances, choose sensible values like 0.1 & 10
                don't forget to set dtype! Want to spend an afternoon debugging? I don't.
        """
