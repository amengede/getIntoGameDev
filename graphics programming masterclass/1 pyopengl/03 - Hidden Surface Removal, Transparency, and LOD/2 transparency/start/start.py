...
class Renderer:
    ...
    def set_up_opengl(self) -> None:
        ...
        """
            Task: enable and configure alpha blending
        """
        #TODO: tell OpenGL to enable blending
        #TODO: tell OpenGL's blend function to use:
        #
        #       the source fragment's alpha as 
        #       the source fragment's coefficient
        #
        #       (1 - src_alpha) as
        #       the destination fragment's coefficient
